...
Este repositório contém a lógica de controle de potência para o aquecimento industrial para forno à indução, implementada em S7-STL (Statement List) para CLPs Siemens (S7-300/400).
